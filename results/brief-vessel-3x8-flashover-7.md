...
```
brain                fireVolume    peakBurning    containedAt extinguishedAtspacesBurnedOut    tetherTicks retardantSpent    droneDeaths     wrongFloor         hedges
...
Play by play
  ...
  t=  2  D5 (retardant) L1-A1 -> L1-A2 coat
  t=  2  D6 (hatch) L1-A1 -> L1-A3 close-door
  t=  3  D5 (retardant) L1-A2 -> L1-A3 coat
  t=  3  D6 (hatch) L1-A2 -> L2-B3 close-door
  ...
  t= 13  D3 (tether) L1-A3 -> L1-A3 suppress
  t= 13  D4 (tether) L1-B3 -> L1-B4 suppress
  t= 13  D6 (hatch) L2-B3 -> L2-B3 close-door
  t= 14  D3 (tether) L1-B3 -> L1-B3 suppress
  t= 14  D4 (tether) L1-B3 -> L1-B3 suppress
...
Play by play
  ...
  t= 12  D5 (retardant) L1-A2 -> L1-A3 coat
  ...
  t= 24  D5 (retardant) L1-A2 -> L1-A3 coat
  ...
  t= 29  D5 (retardant) L1-A3 -> L1-B3 coat
  t= 30  D3 (tether) L1-B3 -> L1-B3 suppress
  t= 30  D4 (tether) L1-B3 -> L1-B3 suppress
  t= 30  D5 (retardant) L1-A2 -> L1-A3 coat
...
Play by play
  ...
  t=  1  contained: no new space ignites after this (1 ever burned)
  t=  2  D5 (retardant) L1-A1 -> L1-A3 coat
  t=  7  D5 (retardant) L1-A3 -> L1-A1 refill
  t=  9  D5 (retardant) L1-A2 -> L1-A3 coat
  t= 11  D5 (retardant) L1-A2 -> L2-A4 coat
  t= 15  D5 (retardant) L2-A4 -> L1-A3 coat
  t= 18  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 20  D5 (retardant) L1-A2 -> L1-A3 coat
  t= 27  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 29  D5 (retardant) L1-A2 -> L1-A3 coat
