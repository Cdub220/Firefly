...
ours                          33               1               1              34               1              68            4.20               0              59               0
...
Play by play
  ...
  t=  8  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 10  D1 (scout) L2-B2 -> L2-B2 observe
  t= 10  D5 (retardant) L1-A1 -> L1-A2 coat
  t= 11  D5 (retardant) L1-A2 -> L1-A3 coat
  t= 12  D1 (scout) L2-B2 -> L2-B2 observe
  t= 16  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 18  D1 (scout) L2-B2 -> L2-B2 observe
  t= 18  D5 (retardant) L1-A1 -> L1-A2 coat
  t= 19  D5 (retardant) L1-A2 -> L1-A3 coat
  t= 20  D1 (scout) L2-B2 -> L2-B2 observe
  t= 24  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 26  D1 (scout) L2-B2 -> L2-B2 observe
  t= 26  D5 (retardant) L1-A1 -> L1-A2 coat
  t= 27  D5 (retardant) L1-A2 -> L1-A3 coat
  t= 28  D1 (scout) L2-B2 -> L2-B2 observe
  t= 32  D5 (retardant) L1-A3 -> L1-A1 refill
  t= 34  D1 (scout) L2-B2 -> L2-B2 observe
  t= 34  D5 (retardant) L1-A1 -> L1-A2 coat
  t= 34  L1-B3 burns out
  t= 34  no space burning
  t= 35  D5 (retardant) L1-A2 -> L2-A4 coat
  t= 35  D6 (hatch) L2-B3 -> L2-B4 close-door
  t= 36  D1 (scout) L2-B2 -> L2-B3 observe
  t= 36  D2 (scout) L1-A1 -> L2-B3 observe
  t= 36  D5 (retardant) L1-A3 -> L1-A3 coat
  t= 36  D6 (hatch) L2-B4 -> L1-B3 close-door
  t= 38  D3 (tether) L1-B3 -> L2-A4 suppress
  t= 38  D4 (tether) L1-B3 -> L2-A4 suppress
  ... 2 more events not shown
...
Outcome
  ...
  water: 68 tether-ticks on suppress; retardant spent 4.20.
  drone deaths: none.
  commands to the wrong place: 59; hedges: 0.
