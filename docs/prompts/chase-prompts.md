...
|---|---|---|---|
| 1 | 8 | Fire physics: heat transfer on edges, ignition, fuel, drone effects, drone death, resupply. `npm run sim` shows the fire spreading. | [checkpoint-1.md](chase/checkpoint-1.md) |
| 2 | 16 | Multi-level structure plans with vertical conduction. First Three.js render of truth. | [checkpoint-2.md](chase/checkpoint-2.md) |
| 3 | 24 | Scenario picker over plan files. Chaos panel generated from `CorruptionConfig`. Play/pause/scrub. | [checkpoint-3.md](chase/checkpoint-3.md) |
| 4 | 32 | Drones and commands rendered. Truth / belief / diff split view with ambiguity and suspect sensors visible. | [checkpoint-4.md](chase/checkpoint-4.md) |
| 5 | 40 | Split-screen baseline vs ours. Containment counter. Demo polish and recording mode. Stretch: high-rise plan. | [checkpoint-5.md](chase/checkpoint-5.md) |
