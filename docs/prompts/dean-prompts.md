...
| 2 | 24 | Hypothesis-set estimator: physical consistency check, `suspectSensors`, ambiguity as sets, honest confidence. One false-certainty number vs baseline. | [checkpoint-2.md](dean/checkpoint-2.md) |
