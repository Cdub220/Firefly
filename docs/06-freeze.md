...
No other aggregated cell has ours above the best baseline on false certainty or wrong dispatch. Ours' false certainty is 0 % in every cell of the table; false certainty on P(burning) at 0.9 is at most 15 % (flashover and mixed on the larger plans, where a burned-out space next to a live fire is held above 0.9 for a few ticks).
