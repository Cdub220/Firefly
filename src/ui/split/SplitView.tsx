  ...
  return (
    <div className={'fx' + (s.demo ? ' demo' : '')}>
      <header>
        ...
        {!s.demo && <div className="cfg">plan={s.plan.name} seed={s.seed} ticks={s.ticks} corruption={JSON.stringify(s.corruption)}{s.dispatch ? ' · closed loop: drones act on commands' : ''}</div>}
